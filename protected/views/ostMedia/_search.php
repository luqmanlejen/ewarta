<div class="row">
    ...
    <a href="index.php?r=ostMedia/admin<?php echo $exturl; ?>" class="btn btn-sm btn-success width-10"><i class="ace-icon fa fa-undo"></i>&nbsp;Reset</a>
    <a href="index.php?r=ostMedia/create<?php echo $exturl; ?>" class="btn btn-sm btn-primary width-10"><i class="ace-icon fa fa-plus"></i>&nbsp;Add</a>
