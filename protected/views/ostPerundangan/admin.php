...
<div class="main-content">
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <div class="page-header"><h1>Other Law</h1></div>
            <div class="row">
                <div class="col-xs-12">
                                ...
                                array('header' => 'Action', 'class' => 'CButtonColumn',
                                    ...
                                    array(
                                        'update' => array(
                                            ...
                                            'url' => 'Yii::app()->createUrl("ostPerundangan/update&id=".$data->id)',
                                            'imageUrl' => false,
                                            'visible' => '1'
                                        ),
                                        'flag' => array(
                                            ...
                                            'imageUrl' => false,
                                            'url' => 'Yii::app()->createUrl("ostPerundangan/flagDelete&id=".$data->id)',
                                            'visible' => '1'
                                        ),
                                    ),
                                ),
