...
$('.search-form form').submit(function(){
	$('#ost-act-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<div id="feedback" class="inner-content">
    ...
    <section id="page-title" class="inner-section">
        <div class="container-fluid nopadding wow fadeInRight" data-wow-delay="0.4s" data-wow-offset="10">
            <h2 class="font-accident-two-normal uppercase"><?php echo $title_act; ?></h2><hr>
    ...
    <section class="inner-section feedback feedback-light">
        ...
        $this->renderPartial('_searchact', array('model' => $model));
        ...
        $this->widget(
            ...
            'columns' => array(
                ...
                //array('name' => OstRefList::model()->getTranslation("05"), 'value' => '$data->download($data->id)'),
                array(
                    ...
                    'buttons' => array(
                        'download_en' => array(
                            ...
                            'label' => '<i class="fa fa-file-pdf-o fa-2x"></i> English',
                            'url' => 'Yii::app()->createUrl("ostAct/download", array("id"=>$data->id,"type"=>1))',
                            'imageUrl' => false,
                        ),
                        'download_bm' => array(
                            'options' => array('rel' => 'tooltip', 'data-toggle' => 'tooltip', 'title' => OstRefList::model()->getTranslation("10")),
                            'label' => '<i class="fa fa-file-pdf-o fa-2x"></i> Malay',
                            'url' => 'Yii::app()->createUrl("ostAct/download", array("id"=>$data->id,"type"=>2))',
                            'imageUrl' => false,
                        ),
                    )
                ),
