...
<div class="container">
    <div class="row">
        <div class="col-sm-2"><?php echo $form->label($model, 'no_act'); ?></div>
        <div class="col-sm-2"><?php echo $form->textField($model, 'no_act', array('size' => 60, 'class' => 'form-control')); ?></div>
    </div>
    <div class="pace-4"></div>
    
    <div class="row">
        <div class="col-sm-2"><b>Act Name</b></div>
        <div class="col-sm-8"><?php echo CHtml::textField('act_name', $name, array('size' => 60, 'class' => 'form-control')); ?></div>
    </div>
    <div class="pace-4"></div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <a href="index.php?r=portal/amendingActList" class="btn btn-info width-10" ><i class="ace-icon fa fa-undo" style="color:white"></i></a>
        </div>
    </div>
</div>
<?php $this->endWidget(); ?>
