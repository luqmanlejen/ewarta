...
<div class="form">
    ...
    <?php $form = $this->beginWidget('CActiveForm', array('id' => 'ost-version-act-form', 'enableAjaxValidation' => false, 'htmlOptions' => array('class' => 'form-horizontal'))); ?>
    <div class="alert alert-danger"><i class="fa fa-info-circle"></i>&nbsp;&nbsp;Field with * are required</div>    
    
    <!--start act id-->
    <div class="form-group">
        <div class="col-sm-2"><?php echo $form->labelEx($model, 'act_id', array('class' => 'control-label')); ?> </div>
        <div class="col-sm-10">
            <?php // echo $form->textField($model, 'act_id', array('maxlength' => 255, 'class' => 'col-sm-2')); ?>
            <?php echo $form->dropdownlist($model, 'act_id', OstAct::model()->displayActList(), array('maxlength' => 255, 'class' => 'col-sm-10')); ?>
    ...
    <!--start version act id-->
    <div class="form-group">
        <div class="col-sm-2"><?php echo $form->labelEx($model, 'version_act_id', array('class' => 'control-label')); ?> </div>
        <div class="col-sm-10">
            <?php echo $form->dropdownlist($model, 'version_act_id', OstRefList::model()->listRef3(6), array('maxlength' => 255, 'class' => 'col-sm-2')); ?>
            <?php echo $form->error($model, 'version_act_id'); ?>	
        </div>
    </div>
    <div class="space-4"></div>
    <!--end version act id-->
    ...
    <!--start version year-->
    <div class="form-group">
        <div class="col-sm-2"><?php echo $form->labelEx($model, 'version_year', array('class' => 'control-label')); ?> </div>
        <div class="col-sm-10">
            <?php echo $form->textField($model, 'version_year', array('maxlength' => 255, 'class' => 'col-sm-2')); ?>
            <?php echo $form->error($model, 'version_year'); ?>	
        </div>
    </div>
    <div class="space-4"></div>
    <!--end version year-->
    ...
    <!--start remarks bm-->
    <div class="form-group">
        <div class="col-sm-2"><?php echo $form->labelEx($model, 'remarks_bm', array('class' => 'control-label')); ?> (English Version)</div>
        <div class="col-sm-10">
    ...
    <div class="clearfix form-actions no-margin">
        <a href="index.php?r=ostVersionAct/admin" class="btn btn-purple"><i class="ace-icon fa fa-arrow-left bigger-110s"></i>&nbsp;Back</a>&nbsp;&nbsp;
