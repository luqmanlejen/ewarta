...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('hrstafperibadi_id')); ?>:</b>
	<?php echo CHtml::encode($data->hrstafperibadi_id); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('ic_no')); ?>:</b>
	<?php echo CHtml::encode($data->ic_no); ?>
	<br />
