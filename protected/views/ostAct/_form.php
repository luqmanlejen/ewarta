...
<div class="form">
    ...
    <?php $form = $this->beginWidget('CActiveForm', array('id' => 'ost-act-form', 'enableAjaxValidation' => false, 'htmlOptions' => array('class' => 'form-horizontal'))); ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <?php echo $form->textField($model, 'no_act', array('maxlength' => 255, 'class' => 'col-sm-2')); ?>
            <?php echo $form->error($model, 'no_act'); ?>
			<?php echo $form->labelEx($model, '/', array('class' => 'control-label col-sm-1')); ?>
			<?php echo $form->labelEx($model, 'year', array('class' => 'control-label col-sm-1')); ?>
			<?php echo $form->textField($model, 'year', array('maxlength' => 255, 'class' => 'col-sm-2')); ?>
		...
		<div class="col-sm-10">
		<?php echo $form->labelEx($model, 'Example : 667', array('class' => 'col-sm-4')); ?>
		<?php echo $form->labelEx($model, 'Example : 2016', array('class' => 'col-sm-4')); ?>
		</div>
    </div>
    <div class="space-4"></div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <?php echo $form->textField($model, 'act_name_bi', array('maxlength' => 255, 'class' => 'col-sm-6')); ?>
            <?php echo $form->error($model, 'act_name_bi'); ?>
			<?php echo $form->labelEx($model, 'Example : Election Offences Act 1954', array('class' => 'col-sm-4')); ?>
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <?php echo $form->textField($model, 'act_name_bm', array('maxlength' => 255, 'class' => 'col-sm-6')); ?>
            <?php echo $form->error($model, 'act_name_bm'); ?>
			<?php echo $form->labelEx($model, 'Example : Kesalahan Pilihan Raya 1954', array('class' => 'col-sm-4')); ?>
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
			...
			<?php echo $form->labelEx($model, 'Example : 98', array('class' => 'col-sm-2')); ?>
        </div>
    </div>
    <div class="space-4"></div>
    ...
    <div class="clearfix form-actions no-margin">
        <a href="index.php?r=ostAct/admin" class="btn btn-purple"><i class="ace-icon fa fa-arrow-left bigger-110s"></i>&nbsp;Back</a>&nbsp;&nbsp;
