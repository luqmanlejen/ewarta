...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('date_proclamation_bi')); ?>:</b>
	<?php echo CHtml::encode($data->date_proclamation_bi); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('date_proclamation_bm')); ?>:</b>
	<?php echo CHtml::encode($data->date_proclamation_bm); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('date_effective_bi')); ?>:</b>
	<?php echo CHtml::encode($data->date_effective_bi); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('date_effective_bm')); ?>:</b>
	<?php echo CHtml::encode($data->date_effective_bm); ?>
	<br />
