...
<div class="main-content">
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <div class="page-header"><h1>Act</h1></div>
            <div class="row">
                <div class="col-xs-12">
                                ...
                                array('header' => 'Action', 'class' => 'CButtonColumn',
                                    ...
                                    array(
                                        'update' => array(
                                            ...
                                            'url' => 'Yii::app()->createUrl("ostAct/update&id=".$data->id)',
                                            'imageUrl' => false,
                                            'visible' => '1'
                                        ),
                                        'flagDelete' => array(
                                            'options' => array('rel' => 'tooltip', 'data-toggle' => 'tooltip', 'title' => 'Flag', 'class' => 'btn btn-xs btn-danger',),
                                            'label' => '<i class="ace-icon fa fa-trash-o bigger-120"></i>',
                                            'imageUrl' => false,
                                            'url' => 'Yii::app()->createUrl("ostAct/flagDelete&id=".$data->id)',
                                            'visible' => '1'
                                        ),
                                    ),
                                ),
...
<!--<scripst src="<?php // echo Yii::app()->theme->baseUrl; ?>/assets/js/jquery.ui.touch-punch.js"></script>-->
