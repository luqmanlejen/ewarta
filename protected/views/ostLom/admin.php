...
$('.search-form form').submit(function(){
	$('#ost-lom-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
    ...
    <div class="main-content-inner">
        ...
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li>Publication</li>
                <li class="active">Laws of Malaysia</li>
            </ul><!-- /.breadcrumb -->
        </div>
        <!-- /section:basics/content.breadcrumbs -->
        ...
        <div class="page-content">
            ...
            <div class="page-header"><h1>Laws of Malaysia</h1></div>
            <div class="row">
                <div class="col-xs-12">
                    <div class="dataTables_wrapper form-inline no-footer" id="dynamic-table_wrapper">
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                ...
                                'lom_no',
                                'lom_title',
                                array('name' => 'lom_type', 'value' => 'OstLom::model()->displaytype($data->lom_type)', 'htmlOptions' => array('width' => '110', 'align' => 'center')),
                                array('name' => 'hits', 'value' => '$data->hits', 'htmlOptions' => array('width' => '70', 'align' => 'center')),
                                array('name' => 'lom_year_rev', 'value' => '$data->displayrev()', 'htmlOptions' => array('width' => '90', 'align' => 'center')),
                                array('name' => 'updated_dt', 'value' => '$data->updated_dt', 'htmlOptions' => array('width' => '90', 'align' => 'center')),
                                array('name' => 'updated_by', 'value' => '$data->author_rel->name'),
                                array('name' => 'lom_lang', 'value' => '$data->displayLang()', 'htmlOptions' => array('width' => '100', 'align' => 'center'),),
                                array('header' => 'Action', 'class' => 'CButtonColumn',
                                    ...
                                    array(
                                        'update' => array(
                                            ...
                                            'url' => 'Yii::app()->createUrl("ostLom/update&id=".$data->id)',
                                            'imageUrl' => false,
                                        ),
                                        'delete' => array(
                                            ...
                                            'imageUrl' => false,
                                            'url' => 'Yii::app()->createUrl("ostLom/delete&id=".$data->id)',
                                        ),
                                    ),
                                ),
                            ),
