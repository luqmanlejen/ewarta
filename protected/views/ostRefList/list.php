...
<div class="main-content">
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <div class="page-header"><h1>Manage Parameter</h1></div>
            <div class="row">
                <div class="col-xs-12">
                    <div class="dataTables_wrapper form-inline no-footer" id="dynamic-table_wrapper">
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'dataProvider' => $model->search($cat_id=$_GET['cat_id']),
                            ...
                            'columns' => array(
                                ...
                                array('name' => 'lang', 'value' => '$data->displayLang($data->id)', 'htmlOptions' => array('width' => '120', 'align' => 'center'),),
                                array('header' => 'Action', 'class' => 'CButtonColumn',
                                    ...
                                    array(
                                        'update' => array(
                                            ...
                                            //'url' => 'Yii::app()->createUrl("ostRefList/update&id=".$data->id)',
