    ...
    <div class="main-content-inner">
        ...
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li>Manage Act</li>
                <li class="active">Amending Act</li>
            </ul><!-- /.breadcrumb -->
        </div>
        <!-- /section:basics/content.breadcrumbs -->
        ...
        <div class="page-content">
            ...
            <div class="page-header"><h1>Amending Act</h1></div>
            <div class="row">
                <div class="col-xs-12">
                                ...
                                array('header' => 'Action', 'class' => 'CButtonColumn',
                                    ...
                                    array(
                                        'update' => array(
                                            ...
                                            'url' => 'Yii::app()->createUrl("ostAmendingAct/update&id=".$data->id)',
                                            'imageUrl' => false,
                                            'visible' => '1'
                                        ),
                                        'flag' => array(
                                            ...
                                            'imageUrl' => false,
                                            'url' => 'Yii::app()->createUrl("ostAmendingAct/flagDelete&id=".$data->id)',
                                            'visible' => '1'
                                        ),
                                    ),
                                ),
