                                    ...
                                    <fieldset>
                                        <label class="block clearfix">
                                            <span class="block input-icon input-icon-right">
                                                ...
                                                <!--<input type="text" class="form-control" placeholder="Email AGC" />-->
...
<!--                                                                                                    <button type="button" class="width-35 pull-right btn btn-sm btn-primary" onclick="js:location.href='index.php?r=site/index'">
